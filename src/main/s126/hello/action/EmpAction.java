...
public class EmpAction extends ActionSupport {
	...
	public String filterSal(){
		emps = empDao.getBySalRange(min, max);
		return "list";
	}

	/* 删除员工 */
	public String delete() {
		return empDao.delete(emp.getId()) ? "delete" : "error";
	}
	...
	public String addIndex() {
		...
		ActionContext.getContext().getSession().put("jobs", empDao.getJobs());
		return "addIndex";
	}
